        ...
        <div className={`w-1/4 border-r-2 border-gray-600 shadow-2xl h-screen bg-sky-300 ${open ? 'w-[300px]' : 'w-24'}`}>
            ...
            <div className={`flex flex-col justify-center items-start gap-4 mt-20 ${open ? 'pl-20' : 'items-center' }`}> 
                <Link href={"/"} className="flex gap-2 items-center cursor-pointer">
                    <AiOutlineHome className="text-4xl hover:text-sky-300"/>
                ...
                <Link href={"/"} className="flex gap-2 items-center cursor-pointer">
                    <LuHeartHandshake className="text-4xl hover:text-sky-300"/>
                ...
                <Link href={"/"} className="flex gap-2 items-center cursor-pointer">
                    <CiLogin className="text-4xl hover:text-sky-300"/>
                ...
                <Link href={"/"} className="flex gap-2 items-center cursor-help">
                    <LuHelpCircle className="text-4xl hover:text-sky-300"/>
            ...
            <div className={`fixed flex gap-2 bottom-0 cursor-pointer ${open ? 'pl-20 pb-3' : 'pl-5 pb-3'}`}>
                <BiLogOut className="text-4xl hover:text-gray-300"/>
