...
export default function CardAtividades({atividade, dataInicio, dataConclusao, image, status, postId, isClosed}){
    ...
    return (
        <Link href={`/vaga/${postId}`} className={status == 'pending' ? 'cursor-pointer border-4 w-96 max-[920px]:w-64  h-96 flex flex-col hover:bg-gray-100 hover:border-gray-500 rounded-xl mb-4 max-[450px]:h-80 max-[380px]:w-72 border-orange-400' 
                    : status=='rejected'? 'cursor-pointer border-4 w-96 max-[920px]:w-64  h-96 flex flex-col hover:bg-gray-100 hover:border-gray-500 rounded-xl mb-4 max-[450px]:h-90 max-[380px]:h-80 border-red-400' 
                    : isClosed==true? 'cursor-pointer border-4 w-96 max-[920px]:w-64 h-96 flex flex-col hover:bg-gray-100 hover:border-gray-500 rounded-xl mb-4 max-[450px]:h-80 max-[380px]:w-72' 
                    : 'cursor-pointer border-4 w-96 max-[920px]:w-64 h-96 flex flex-col hover:bg-gray-100 hover:border-gray-500 rounded-xl mb-4 max-[450px]:h-80 max-[380px]:w-72'}>
            <div className=''>
                <Image
                src={image.image}
                width={100}
